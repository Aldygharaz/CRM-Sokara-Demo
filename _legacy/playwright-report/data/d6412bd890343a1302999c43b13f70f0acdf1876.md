...
- Name: deal-management.spec.js >> Deal Management Operational Flows >> should edit an existing deal and update dashboard metrics
- Location: tests\deal-management.spec.js:35:3
...
Call log:
  ...
  - waiting for locator('#edit-deal-modal')
    14 × locator resolved to <div id="edit-deal-modal" class="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 hidden flex items-center justify-center p-4">…</div>
